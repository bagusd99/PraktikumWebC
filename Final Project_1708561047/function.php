<?php
$koneksi = mysqli_connect('localhost', 'root', 'root', 'db_simak');
...
function register()
{
    ...
    $query_user = "INSERT INTO mahasiswa VALUES (NULL, '1', '$nim','$nama', '$email', '$alamat', '$tgl_lahir', 'aktif','$password')";
...
function registerDosen()
{
    ...
    $alamat = htmlspecialchars($_POST['alamat']);
    $tgl_lahir = $_POST['tgl_lahir'];
    $query_user = "INSERT INTO dosen VALUES (NULL, '2', '$nip', '$nidn','$nama', '$email', '$alamat', '$tgl_lahir', 'aktif','$password')";
    $exe = mysqli_query($koneksi, $query_user);
...
function registerAdmin()
{
    ...
    $alamat = htmlspecialchars($_POST['alamat']);
    $tgl_lahir = $_POST['tgl_lahir'];
    $query_user = "INSERT INTO adminsimak VALUES (NULL, '0', '$nip','$nama', '$email', '$alamat', '$tgl_lahir','$password')";
    $exe = mysqli_query($koneksi, $query_user);
...
function tambahMatkul()
{
    ...
    $queryMatkul = "INSERT INTO matakuliah VALUES (NULL,'$kode_mk', '$matakuliah', '$sks')";
...
function bimbinganPA()
{
    ...
    $queryBimbingan = "INSERT INTO bimbingan VALUES (NULL,'$dosen', '$mahasiswa')";
...
function buatKelas()
{
    ...
    $queryKelas = "INSERT INTO kelas VALUES (NULL,'$namaKelas', '$jamKuliah', '$kuotaKelas', '$dosen', '$status')";
...
function joinKelas()
{
    ...
    $queryKelas = "INSERT INTO join_kelas VALUES (NULL,'$mahasiswa', '$idKelas')";
...
function tambahKRS()
{
    ...
    $queryKRS = "INSERT INTO krs VALUES (NULL,'$semester', '$mahasiswa', '$id_mk')";
